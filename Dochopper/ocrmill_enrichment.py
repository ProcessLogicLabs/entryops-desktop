...
Adapts the logic from dochopper.py's _process_with_complete_data() for
...
class EnrichmentPipeline:
    ...
    def enrich(self, items: List[Dict], net_weight: float, override_mid: str = '',
        ...
        try:
            from Dochopper.dochopper import normalize_invoice_uom
        except ImportError:
            from dochopper import normalize_invoice_uom
