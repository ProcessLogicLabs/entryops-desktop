...
to XLSX with material-type color coding, matching the main DocHopper
export formatting.
"""
...
# Default column order (matches dochopper.py line 13354)
...
class ProfileExporter:
    ...
    def write_xlsx(self, df_out: pd.DataFrame, cols: List[str], filepath: Path,
        ...
        """
        # Default colors (same as dochopper.py _export_single_file)
        steel_color = '#4a4a4a'
        ...
        try:
            ...
            settings = QSettings("DocHopper", "DocHopper")
