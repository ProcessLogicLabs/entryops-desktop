"""
AI Agent Integration - Bridges the existing EntryOps UI with the new agent system
...
# Display-name → model-ID mapping. Kept for backward compatibility — the
# Template Assistant dropdown now stores model IDs directly, so callers
# should treat unrecognised values as already-resolved IDs.
ANTHROPIC_MODELS = {
