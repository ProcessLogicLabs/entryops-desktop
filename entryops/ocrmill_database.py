"""
OCRMill Database Extensions for EntryOps
Extends EntryOps's database with OCR invoice processing capabilities.
"""
...
class OCRMillDatabase:
    ...
    Uses EntryOps's existing database with additional OCRMill tables.
    """
    ...
    def _update_part_master(self, cursor, part_number: str, part_data: Dict):
        ...
        # Convert percentages to EntryOps's 0-100 format if needed
