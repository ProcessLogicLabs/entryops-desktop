"""
EntryOps Premium Splash Screen
...
class AnimatedMillSplash(QWidget):
    """Premium splash screen for EntryOps."""

    def __init__(self, app_name: str = "EntryOps", version: str = "", parent=None):
    ...
    def _draw_center_emblem(self, painter):
        ...
        # text glyph; same drawing works for both the EntryOps and
        # EntryOps brands since both share the mill/hopper iconography.
    ...
    def _draw_tagline(self, painter):
        ...
        EntryOps and EntryOps render their respective taglines from a
        ...
        try:
            from entryops._branding import APP_TAGLINE
        except ImportError:
            try:
    ...
    def _draw_corner_accents(self, painter):
        ...
        if self.version:
            ...
            painter.drawText(QRectF(0, 308, self.width(), 20), Qt.AlignCenter, ver)
            painter.restore()
...
def create_splash(app_name: str = "EntryOps", version: str = "") -> AnimatedMillSplash:
...
if __name__ == "__main__":
    ...
    splash = create_splash("EntryOps", "2.4.0")
    splash.show()
